                  ...
                  <div style={{ display: "flex", flexDirection: "row" }}>
                    ...
                    >
                      {rooms.length > 0 ? (
                                    ...
                                    onChange={(newValueDate) => {
                                      ...
                                      if (newCheckIn && newCheckOut) {
                                        const startDate = dayjs(
                                          newValueDate[0]
                                        ).tz("Asia/Bangkok"); // ค่าตั้งต้น
                                        const endDate = dayjs(
                                          newValueDate[1]
                                        ).tz("Asia/Bangkok"); // วันที่ Check-out ใหม่
                                    ...
                                    onClick={async () => {
                                      try {
                                        ...
                                        if (valueDate[0]) {
                                          ...
                                          const getarrayshow1 =
                                            valueDate[0]?.get("D").valueOf() ||
                                            0;
                                          const getarrayshow2 =
                                            valueDate[0]?.get("M").valueOf() ||
                                            0;
                                          const getarrayshow3 =
                                            valueDate[0]?.get("y").valueOf() ||
                                            0;
                                        ...
                                        if (valueDate[1]) {
                                          ...
                                          const getarrayshow1 =
                                            valueDate[1]?.get("D").valueOf() ||
                                            0;
                                          const getarrayshow2 =
                                            valueDate[1]?.get("M").valueOf() ||
                                            0;
                                          const getarrayshow3 =
                                            valueDate[1]?.get("y").valueOf() ||
                                            0;
                        ...
                        >
                          <p>
                            ยังไม่มีข้อมูลห้อง โปรดดำเนินการเลือกข้อมูลโรงแรม
                          </p>
                        </div>
                      )}
                    </div>
                                ...
                                <TableBody>
                                  {rooms.map((room_hotel) => (
                                    <TableRow>
                                      ...
                                      <TableCell>{room_hotel.price}</TableCell>
                                    </TableRow>
                                  ))}
                                </TableBody>
                              </Table>
